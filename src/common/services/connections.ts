...
const getRoomWithConnection = async (
  userId: number
): Promise<RoomDetail | null> => {
  let url = `/api/v1/chat/connections/users/${userId}`;
...
const createRoomWithConnection = async (
  userId: number
): Promise<RoomDetail | null> => {
  let url = `/api/v1/chat/connections/users/${userId}`;
...
export { getRooms, getRoomDetail, getConnections, getRoomWithConnection, createRoomWithConnection };
